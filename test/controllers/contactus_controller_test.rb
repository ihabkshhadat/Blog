...
class ContactusControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contactu" do
    assert_difference("Contactu.count") do
      post contactus_url, params: { contactu: { email: @contactu.email, message: @contactu.message, name: @contactu.name, subject: @contactu.subject } }
    end
  ...
  test "should update contactu" do
    patch contactu_url(@contactu), params: { contactu: { email: @contactu.email, message: @contactu.message, name: @contactu.name, subject: @contactu.subject } }
